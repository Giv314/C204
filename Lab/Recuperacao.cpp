...
int main()
{
	...
	int f[2][100]; // menor tempo para levar um chassi desde a entrada atÃ© a estacao da linha "i" e maquina "j" -> f[0,4]
	...
	// caso geral
	for (int maq = 1;maq < n; maq++) // A maquina 0 jÃ¡ foi processada no caso base
	{
