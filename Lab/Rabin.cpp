...
void rabin_karp(char T[], char P[], int tamT, int tamP, int d, int q)
{
	...
	cout << "Ultima ocorrencia: " << ut << endl;
...
int main()
{
	...
	char padrao[100]; // Padrão a ser buscado
	int tamT; // Tamanho do texto
	int tamP; // Tamanho do padrao
	...
	rabin_karp(texto, padrao, tamT, tamP, d, q);
